  ...
  <body>
    ...
    <header class="masthead text-center text-white">
      <div class="masthead-content">
        <div class="container">
          <h1 class="masthead-heading mb-0">Welcome home</h1>
          <h2 class="masthead-subheading mb-0">Ready to rock and roll?</h2>
        </div>
      </div>
    ...
    <footer class="py-5 bg-black">
      <div class="container">
        <p class="m-0 text-center text-white small">Copyright &copy; Joshua Ratliff 2018</p>
      </div>
      <!-- /.container -->
    </footer>
